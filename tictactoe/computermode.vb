Public Class computermode
    ...
    Private Sub computermode_Click(sender As Object, e As EventArgs) Handles MyBase.Click, Button9.Click, Button8.Click, Button7.Click, Button6.Click, Button5.Click, Button4.Click, Button3.Click, Button2.Click, Button1.Click
        sender.text = "X"
    ...
    Private Sub checkIfComputerWins()
        If Button1.Text = "O" And Button2.Text = "O" And Button3.Text = "O" Or Button4.Text = "O" And Button5.Text = "O" And Button6.Text = "O" Or Button7.Text = "O" And Button8.Text = "O" And Button9.Text = "O" Or Button1.Text = "O" And Button4.Text = "O" And Button7.Text = "O" Or Button2.Text = "O" And Button5.Text = "O" And Button8.Text = "O" Or Button3.Text = "O" And Button6.Text = "O" And Button9.Text = "O" Or Button1.Text = "O" And Button5.Text = "O" And Button9.Text = "O" Or Button3.Text = "O" And Button5.Text = "O" And Button7.Text = "O" Then
            ...
            Button9.Text = ""
            Button9.Enabled = True
        ElseIf Button1.Text = "X" And Button2.Text = "X" And Button3.Text = "X" Or Button4.Text = "X" And Button5.Text = "X" And Button6.Text = "X" Or Button7.Text = "X" And Button8.Text = "X" And Button9.Text = "X" Or Button1.Text = "X" And Button4.Text = "X" And Button7.Text = "X" Or Button2.Text = "X" And Button5.Text = "X" And Button8.Text = "X" Or Button3.Text = "X" And Button6.Text = "X" And Button9.Text = "X" Or Button1.Text = "X" And Button5.Text = "X" And Button9.Text = "X" Or Button3.Text = "X" And Button5.Text = "X" And Button7.Text = "X" Then
